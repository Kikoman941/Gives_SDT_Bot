...
const (
	...
	CANNOT_PARSE_CHANNEL_message = "Не могу распознать канал %d. Проверьье корректность ввода или обратитесь к разработчику"
	...
	CANNOT_UPDATE_FINISHED__GIVE_message      = "Конкурс giveId=%d завершен, не могу обновить его. Обратитесь к разработчику"
)
